    ...
    : DiffNotifyJobBase<StfcServerStatus>(db, dispatcher, embedBranding)
{
    ...
    protected override string? Title(Language lang) => Msg.Server.StatusChangeTitle(lang);
    ...
    protected override (string Content, NetCord.Color Color) BuildAnnouncement(StfcServerStatus status, Language lang)
    {
